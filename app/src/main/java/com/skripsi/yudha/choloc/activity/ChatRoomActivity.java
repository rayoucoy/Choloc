...
import com.skripsi.yudha.choloc.adapter.ChatRoomThreadAdapter;
import com.skripsi.yudha.choloc.app.EndPoints;
import com.skripsi.yudha.choloc.HomeActivity;
import com.skripsi.yudha.choloc.model.Message;
import com.skripsi.yudha.choloc.model.User;

import com.skripsi.yudha.choloc.SessionManagement;
...
public class ChatRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = HomeActivity.getSession();
        HashMap<String, String> usdetails = session.getUserDetails();
        String selfUserId = usdetails.get(SessionManagement.KEY_ID);
        usid = selfUserId;

        //String selfUserId = HomeActivity.getInstance().getPrefManager().getUser().getId();
